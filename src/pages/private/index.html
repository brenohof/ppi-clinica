            ...
            <div class="container">
                ...
                <div class="justify-content-end collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a prop-spa="./lista-paciente.html" class="dropdown-item" href="#">Pacientes</a></li>
                            <li><a prop-spa="./lista-funcionario.html" class="dropdown-item" href="#">Funcionários</a></li>
                            <li><a prop-spa="./lista-enderecos.php" class="dropdown-item" href="#">Endereços</a></li>
                            <li><a prop-spa="./lista-agendamentos.html" class="dropdown-item" href="#">Agendamentos</a></li>
                        </ul>
                    </li>
                </div>
            </div>
